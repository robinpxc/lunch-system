      ...
      <form>
        ...
        <div class="form-row combo-container">
          ...
          <div class="form-row col-md-10 combo-01">
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-01-01" placeholder="一号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-01-02" placeholder="二号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <div class="input-group">
                <input type="text" class="form-control" id="food-01-03" placeholder="三号菜" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-row combo-container">
          ...
          <div class="form-row col-md-10 combo-02">
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-02-01" placeholder="一号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-02-02" placeholder="二号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <div class="input-group">
                <input type="text" class="form-control" id="food-02-03" placeholder="三号菜" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-row combo-container">
          ...
          <div class="form-row col-md-10 combo-03">
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-03-01" placeholder="一号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-03-02" placeholder="二号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <div class="input-group">
                <input type="text" class="form-control" id="food-03-03" placeholder="三号菜" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-row combo-container">
          ...
          <div class="form-row col-md-10 combo-01">
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-04-01" placeholder="一号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-04-02" placeholder="二号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <div class="input-group">
                <input type="text" class="form-control" id="food-04-03" placeholder="三号菜" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-row combo-container">
          ...
          <div class="form-row col-md-10 combo-01">
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-05-01" placeholder="一号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-05-02" placeholder="二号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <div class="input-group">
                <input type="text" class="form-control" id="food-05-03" placeholder="三号菜" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-row combo-container">
          ...
          <div class="form-row col-md-10 combo-01">
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-06-01" placeholder="一号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <input type="text" class="form-control" id="food-06-02" placeholder="二号菜" required>
            </div>
            <div class="col-md-4 mb-3">
              <div class="input-group">
                <input type="text" class="form-control" id="food-06-03" placeholder="三号菜" required>
              </div>
            </div>
          </div>
        </div>
