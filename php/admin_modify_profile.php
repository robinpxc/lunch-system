  ...
  <div class="profile-form-container mt-4">
    ...
    <form class="profile-form" action="" method="post">
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" name="user-id" aria-label="user-id" class="form-control less-permission-input profile-input" value="<?php echo $userId; ?>" maxlength="4" readonly="readonly" />
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" name="user-fullname" aria-label="user-fullname" class="form-control less-permission-input profile-input" value="<?php echo $userFullName; ?>" readonly="readonly" />
        <div class="input-group-append permission-text">
