    ...
    <div class="collapse navbar-collapse" id="nav-bar-list">
      ...
      <div class="admin-nav">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item admin-nav-item admin-item-data data active">
            <a class="nav-link">
              <span class="d-flex justify-content-left align-items-center">
  ...
  <form class="profile-form">
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" name="user-id" id="user-id-input" aria-label="user-id"
             class="form-control less-permission-input profile-input" value="" disabled="disabled"/>
    </div>
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" name="user-fullname" id="user-fullname-input" aria-label="user-fullname"
             class="form-control less-permission-input profile-input" value="" maxlength="30" disabled="disabled"/>
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" name="user-nickname-edit" id="nickname-input" aria-label="user-nickname"
             class="form-control profile-input" value="" disabled="disabled" required maxlength="30">
    ...
    <div class="input-group mb-3">
      ...
      <input type="password" id="password-input" name="user-password-edit" data-options="required:true"
             aria-label="user-password" class="form-control profile-input" placeholder="点击[修改]设置新密码" required
      ...
      <div class="input-group-append">
        <button class="btn btn-outline-secondary" type="button" id="show-hide-pwd-btn" disabled>
          ...
          <svg class="icon-eye" id="eye-icon-disabled" viewBox="0 0 1024 1024">
            <path
